...
json_file = "ephemerides/ephemeris_sample_2025-10-03.json"
...
results = geo_range.calculate_satellite_position_and_range(json_file, "E24", receiver_ecef, utc_time, gnss_week, gnss_tow, receiver_clock_bias=clock_bias_at_rcvTOW_s)

residual = combined_pseudorange_GAL - results['expected_pseudorange_m']
...
print(f"  Measured Pseudorange:   {combined_pseudorange_GAL:>15,.2f} m")
