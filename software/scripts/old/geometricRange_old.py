...
def main():
    ...
    GROUND_ECEF = (863794.228, -5503182.971, 3095968.875)  # X, Y, Z in meters
    SATELLITE_ID = "G04"  # Satellite ID with prefix (e.g., "G18" for GPS, "E24" for Galileo)
    TARGET_TIME = datetime(2025, 10, 2, 20, 18, 00)  # UTC time
    EPHEMERIS_FILE = 'ephemeris.json'  # Path to JSON file
    # =========================
