...
json_file = "../data/ephemerides/ephemeris_sample_2025-10-03.json"
...
results = geo_range.calculate_satellite_position_and_range(json_file, "E24", receiver_ecef, utc_time, gnss_week, gnss_tow)
