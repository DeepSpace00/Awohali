#!/usr/bin/env python3
"""
Example usage of the Galileo I/NAV Parser

This script demonstrates:
1. Parsing a UBX file for Galileo data
2. Accessing individual word types
3. Assembling complete ephemerides
4. Extracting specific parameters
"""

from galileo_sfrbx_parser import GalileoINavParser, parse_ubx_file
import json
