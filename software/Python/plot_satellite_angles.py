"""
Satellite Elevation and Azimuth Plotting Module

This module provides functions to visualize satellite elevation and azimuth angles
over time from nested Pandas DataFrame structures.

Functions:
    plot_elevation_time: Plot elevation vs time for all satellites
    plot_azimuth_time: Plot azimuth vs time for all satellites
    plot_skyplot: Create polar skyplot showing satellite tracks
    plot_elevation_azimuth_combined: Create combined elevation and azimuth plots
    plot_satellite_visibility: Show satellite visibility periods
"""
