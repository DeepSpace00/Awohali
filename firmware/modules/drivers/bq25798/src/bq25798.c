...
static bq25798_status_t bq25798_write_register(const bq25798_t *dev, const uint8_t reg, const uint8_t value) {
    ...
    return dev->io.i2c_write(dev->i2c_address, data, 2, dev->io.ctx) == 0 ? BQ25798_OK : BQ25798_ERR_I2C;
}
...
static bq25798_status_t bq25798_read_register(const bq25798_t *dev, const uint8_t reg, uint8_t *value) {
    if (dev->io.i2c_write(dev->i2c_address, &reg, 1, dev->io.ctx) != 0) return BQ25798_ERR_I2C;

    return dev->io.i2c_read(dev->i2c_address, value, 1, dev->io.ctx) == 0 ? BQ25798_OK : BQ25798_ERR_I2C;
}
...
static bq25798_status_t bq25798_write_registers(const bq25798_t *dev, const uint8_t reg, const uint8_t *data, const size_t length) {
    ...
    return dev->io.i2c_write(dev->i2c_address, buffer, length + 1, dev->io.ctx) == 0 ? BQ25798_OK : BQ25798_ERR_I2C;
}
...
static bq25798_status_t bq25798_read_registers(const bq25798_t *dev, const uint8_t reg, uint8_t *data, const size_t length) {
    ...
    return dev->io.i2c_read(dev->i2c_address, data, length, dev->io.ctx) == 0 ? BQ25798_OK : BQ25798_ERR_I2C;
}
...
bq25798_status_t bq25798_init(bq25798_t *dev, const uint8_t address, const bq25798_interface_t io){
    ...
    if (dev->io.i2c_write(dev->i2c_address, &reg, 1, dev->io.ctx) != 0) return BQ25798_ERR_I2C; // Try to read part number to check if I2C is working
    uint8_t value;
    io.i2c_read(dev->i2c_address, &value, 1, dev->io.ctx);
