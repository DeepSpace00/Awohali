...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x035b);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_VID, 0x2341);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_INITIALIZE_AT_BOOT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 150);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 400000000);
