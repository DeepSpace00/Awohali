 ...
 * @date 2025-08-19
 *
 * This example demonstrates basic usage of the ZEDF9P driver including:
 * - Initialization and configuration
 * - Reading PVT (Position, Velocity, Time) data
 * - Reading high precision position data (HPPOSLLH)
 * - Reading raw measurement data (RAWX)
...
// I2C Configuration
TwoWire* selected_i2c;          // &Wire, &Wire1, &Wire2, etc.
unsigned long i2c_frequency = 400000;   // I2C frequency in Hz

// UART Configuration
HardwareSerial* selected_uart;  // &Serial1, &Serial2, &Serial3, etc.
...
bool enable_rawx = false;
bool configure_as_rover = true;
...
String get_fix_type_string(const uint8_t fix_type) {
    switch (fix_type) {
        case 0: return "NoFix";
