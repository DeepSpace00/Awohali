...
bq76905_status_t bq76905_fet_enable(bq76905_t *dev, bool *fet_en);
...
bq76905_status_t bq76905_get_device_number(bq76905_t *dev, uint16_t *device_number);

bq76905_status_t bq76905_get_firmware_version(bq76905_t *dev, uint16_t *firmware_version, uint16_t *build_number);

bq76905_status_t bq76905_get_hardware_version(bq76905_t *dev, uint16_t *hardware_version);

bq76905_status_t bq76905_get_passq(bq76905_t *dev, uint64_t *passq);
